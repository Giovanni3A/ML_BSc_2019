include("./k-cluster.jl")
using PyPlot, LinearAlgebra, .Cluster
# -------------------------------------------------------------
...
k = 10
C = Cluster.k_cluster(k,neighbors)
...
if d == 1
    ...
    PyPlot.savefig("D:\\Personal\\EMAp\\Machine Learning\\8-RBF\\k-RBF-network.pdf")
end
